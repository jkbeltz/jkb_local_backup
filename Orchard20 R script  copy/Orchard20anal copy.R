...
cagedata=unique(all.cage.sum)
View(cagedata)
####subset cagedata####
APcagedata= subset(cagedata,cagedata$treatment== "A")
ATcagedata= subset(cagedata,cagedata$treatment== "AT")
LBcagedata= subset(cagedata,cagedata$treatment== "LB")
View(ATcagedata)
...
LDg <-  ggplot(gdata, aes(x=as.factor(Timepoint), y=LD, group=treatment))+
  ...
  geom_linerange(aes(ymin=LD-LDse,ymax=LD+LDse, color=treatment), size=1)+
...
LDg1=LDg + theme(legend.position = c(0.6, 0.15))
LDg2<-LDg+geom_line(linetype= "solid" , data=APcagedata, aes(x=as.factor(Timepoint), y=LD, group=Cage), color="#848FA2", size=.5, alpha=.4)
LDg3<-LDg2+geom_line(linetype= "solid", data=ATcagedata, aes(x=as.factor(Timepoint), y=LD, group=Cage), color="#CC2D35", size=.5, alpha=.4)
LDg4<-LDg3+geom_line(linetype="solid", data=LBcagedata, aes(x=as.factor(Timepoint), y=LD, group=Cage), color="#058ED9", size=.5, alpha=.4)
LDg4
...
LDmg <- ggplot(gdata, aes(x=as.factor(Timepoint), y=LDm, group=Cage))+
  geom_point(aes(color=treatment),size=5)+
  geom_line(aes(color=treatment))+
...
LDfg <- ggplot(gxdata, aes(x=as.factor(Timepoint), y=LDf, group=treatment))+
  geom_point(aesA(color=treatment),size=5)+
  geom_line(aes(color=treatment))+
...
#####GRAPH-Viability-APATLB024####
Vg <- ggplot(gdata, aes(x=as.factor(Timepoint), y=V, group=treatment))+
  geom_point(aes(color=treatment),size=4)+
  geom_line(aes(color=treatment),size=1.5)+
  geom_linerange(aes(ymin=V-Vse,ymax=V+Vse, color=treatment), size=1)+
...
Vg1=Vg + theme(legend.position = c(0.65, 0.2))
Vg2<-Vg+geom_line(linetype= "solid" , data=APcagedata, aes(x=as.factor(Timepoint), y=V, group=Cage), color="#848FA2", size=.5, alpha=.4)
Vg3<-Vg2+geom_line(linetype= "solid", data=ATcagedata, aes(x=as.factor(Timepoint), y=V, group=Cage), color="#CC2D35", size=.5, alpha=.4)
Vg4<-Vg3+geom_line(linetype="solid", data=LBcagedata, aes(x=as.factor(Timepoint), y=V, group=Cage), color="#058ED9", size=.5, alpha=.4)
Vg4
...
####GRAPH-STARVfemale-APATLB024####
STARVfg <- ggplot(gdata, aes(x=as.factor(Timepoint), y=Starvf, group=treatment))+
  geom_point(aes(color=treatment),size=4)+
  geom_line(aes(color=treatment),size=1.5)+
  geom_linerange(aes(ymin=Starvf-Starvfse,ymax=Starvf+Starvfse, color=treatment), size=1)+
...
STARVfg1=STARVfg + theme(legend.position = c(0.65, 0.8))
STARVfg2<-STARVfg+geom_line(linetype= "solid", data=APcagedata, aes(x=as.factor(Timepoint), y=Starvf, group=Cage), color="#848FA2", size=.5, alpha=.4)
STARVfg3<-STARVfg2+geom_line(linetype= "solid", data=ATcagedata, aes(x=as.factor(Timepoint), y=Starvf, group=Cage), color="#CC2D35", size=.5, alpha=.4)
STARVfg4<-STARVfg3+geom_line(linetype= "solid", data=LBcagedata, aes(x=as.factor(Timepoint), y=Starvf, group=Cage), color="#058ED9", size=.5, alpha=.4)
STARVfg4
#####GRAPH!-FECUNAPATLB-024####
Fecung <- ggplot(gdata, aes(x=as.factor(Timepoint), y=Fecun, group=treatment))+
  geom_point(aes(color=treatment),size=4)+
  geom_line(aes(color=treatment),size=1.5)+
  geom_linerange(aes(ymin=Fecun-Fecunse,ymax=Fecun+Fecunse, color=treatment), size=1)+
...
Fecung1=Fecung + theme(legend.position = c(0.65, 0.8))
Fecung2<-Fecung+geom_line(linetype= "solid", data=APcagedata, aes(x=as.factor(Timepoint), y=Fecun, group=Cage), color="#848FA2", size=.5, alpha=.4)
Fecung3<-Fecung2+geom_line(linetype= "solid", data=ATcagedata, aes(x=as.factor(Timepoint), y=Fecun, group=Cage), color="#CC2D35", size=.5, alpha=.4)
Fecung4<-Fecung3+geom_line(linetype= "solid", data=LBcagedata, aes(x=as.factor(Timepoint), y=Fecun, group=Cage), color="#058ED9", size=.5, alpha=.4)
Fecung4
...
SFStarvf2 + theme(legend.title=element_blank())
...
colorset= c('Apple'='#848FA2', 'Sterilized Apple'= '#E1DAAE', 'Apple + Ac. Thailandicus' = '#CC2D35','Bloomington'= '#2D3142', 'Apple + Lac. Brevis' = '#058ED9')
colorset2= c('Apple'='#848FA2', 'Axenic'= '#E1DAAE', 'AT' = '#CC2D35','Bloom'= '#2D3142', 'LB' = '#058ED9')

FBARLD <- ggplot(fdata, aes(x=treatmentpheno, y=LD))+
  scale_colour_manual(name = NULL, values = colorset)+
  geom_linerange(aes(ymin=LD-LDse,ymax=LD+LDse, color=treatmentpheno), size=1.5)+
  geom_point(aes(color=treatmentpheno), size=6)+
...
FBARSTARV <- ggplot(fdata, aes(x=treatmentpheno, y=Starvf))+
  scale_colour_manual(name = NULL, values = colorset)+
  geom_linerange(aes(ymin=Starvf-Starvfse,ymax=Starvf+Starvfse, color=treatmentpheno), size=1.5)+
  geom_point(aes(color=treatmentpheno), size=6)+
...
FBARFECUN <- ggplot(fdata, aes(x=treatmentpheno, y=Fecun))+
  scale_colour_manual(name = NULL, values = colorset)+
  geom_linerange(aes(ymin=Fecun-Fecunse,ymax=Fecun+Fecunse, color=treatmentpheno), size=1.5)+
  geom_point(aes(color=treatmentpheno), size=6)+
...
FBARVIA <- ggplot(fdata, aes(x=treatmentpheno, y=V))+
  scale_colour_manual(name = NULL, values = colorset)+
  geom_linerange(aes(ymin=V-Vse,ymax=V+Vse, color=treatmentpheno), size=1.5)+
  geom_point(aes(color=treatmentpheno), size=6)+
  ylab("Egg To Adult Viability")+
  xlab("Phenotyping Treatment")+
  theme_cowplot()+
...
FBARDW <- ggplot(founddata, aes(x=cagetreatment, y=DW))+
  scale_colour_manual(name = NULL, values = colorset2)+
  geom_linerange(aes(ymin=DW-DWse,ymax=DW+DWse, color=cagetreatment), size=1.5)+
  geom_point(aes(color=cagetreatment), size=6)+
...
FBARASPL <- ggplot(founddata, aes(x=cagetreatment, y=ASPL))+
  scale_colour_manual(name = NULL, values = colorset2)+
  geom_linerange(aes(ymin=ASPL-ASPLse,ymax=ASPL+ASPLse, color=cagetreatment), size=1.5)+
  geom_point(aes(color=cagetreatment), size=6)+
  ylab("Pooled Dry Weight")+
  xlab("Phenotyping Treatment")+
  theme_cowplot()+
...
library("ggpubr")
 ...
 Found=ggarrange(
   FBARLD, FBARDW,  FBARFECUN, FBARVIA, FBARSTARV, FBARASPL,  common.legend = TRUE, legend = "right", labels= c("A", "B", "C", "D", "E", "F"), ncol=3, nrow = 2)
Found
