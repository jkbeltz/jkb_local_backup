...
########was also looking for how the particulate model of inheritance fits NS particularly well or how blending inheritance could only fit with the input of variation from mutation or the "acquire traits" -2 me####
